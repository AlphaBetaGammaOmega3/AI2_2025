    ...
    const vendas = [
        {
            ...
            descricao: 'descrição descrição descrição descrição descrição descrição descrição descrição',
            preco: '00,00€',
            categoria: 'categoria',
            tamanho: 'tamanho',
        ...
        // Adiciona mais objetos para simular vendas
    ];
        ...
        <div className="page-container">
            ...
            <div className="header">
                <div className="nav-buttons">
                    <button className="nav-button" onClick={() => navigate('/admin/main')} >Utilizadores</button>
                    <button className="nav-button" onClick={() => navigate('/admin/produtos')} >Produtos</button>
            ...
            <div className="content">
                ...
                <div className="button-container">
                    <button onClick={() => navigate('/admin/produto')} className="edit-button">Editar</button>
